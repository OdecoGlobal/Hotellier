    ...
    users: [
        {
            ...
            password: (0, bcryptjs_1.hashSync)("123456789", 10),
    ...
    hotels: [
        {
            ...
            description: "Luxury hotel in the heart of Lagos with world-class amenities",
            ...
            locationBrief: "Prime location in Victoria Island, Lagos with beach access.",
        ...
        },
        {
            ...
            description: "Traditional hospitality meets modern comfort in ancient Kano.",
